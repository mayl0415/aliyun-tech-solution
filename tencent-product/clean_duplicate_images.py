...
DEFAULT_DIR = Path(__file__).parent / 'products'
PRODUCTS_DIR = DEFAULT_DIR
...
def main():
    ...
    parser.add_argument('--dir', type=str, help='指定扫描目录（默认 products/）')
    args = parser.parse_args()

    global PRODUCTS_DIR, REPORT_FILE
    if args.dir:
        PRODUCTS_DIR = Path(args.dir)
        REPORT_FILE = PRODUCTS_DIR.parent / f'duplicate_images_report_{PRODUCTS_DIR.name}.json'
